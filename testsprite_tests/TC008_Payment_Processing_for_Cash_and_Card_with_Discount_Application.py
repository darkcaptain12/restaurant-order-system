...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click 'Siparişi Gönder' to send the order and proceed to payment
        ...
        # -> Click 'Siparişi Gönder' to proceed to payment screen and check for discount or payment options there
        frame = context.pages[-1]
        # Click 'Siparişi Gönder' to proceed to payment screen
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div[2]/div/div[3]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
