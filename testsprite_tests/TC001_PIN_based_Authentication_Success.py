...
async def run_test():
    ...
    try:
        ...
        await expect(frame.locator('text=Menü').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Siparişlerim (0)').first).to_be_visible(timeout=30000)
